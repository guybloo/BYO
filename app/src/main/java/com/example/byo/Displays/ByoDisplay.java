...
public class ByoDisplay {
    ...
    public ByoDisplay(Byo byo, final Context context){
        ...
        ((TextView)view.findViewById(R.id.byo_display_title)).setText(byo.getTitle());
    }
...
//    }
     ...
     * @param listener
     */
    public void setOnDeleteListener(ByoDisplay.onDeleteListener listener) {
